...
Gem::Specification.new do |spec|
  ...
  spec.homepage      = "https://github.com/functionscompanion/just-the-docs"
  spec.license       = "MIT"
  spec.metadata      = {
    "bug_tracker_uri"   => "https://github.com/functionscompanion/just-the-docs/issues",
    "changelog_uri"     => "https://github.com/functionscompanion/just-the-docs/blob/main/CHANGELOG.md",
    "documentation_uri" => "https://just-the-docs.github.io/just-the-docs/",
    "source_code_uri"   => "https://github.com/functionscompanion/just-the-docs",
  }
